...
Claude、Codex、Antigravity、Cursor、OpenCode、model-runtime、gateway、proxy、direct-API integration は明示された integration point で強い semantic content evidence を提供できますが、provider-hidden state は見えません。
